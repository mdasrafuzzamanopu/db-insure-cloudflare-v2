...
import HeroSection from "../../components/location-test/HeroSection";
import ContactSection from "../../components/location-test/ContactSection";
import FeaturedItemsSection from "../../components/location-test/FeaturedItemsSection";
import FeatureHighlightSection from "../../components/location-test/FeatureHighlightSection";
import TestimonialsSection from "../../components/TestimonialsSection";
import ServicesSection from "../../components/location-test/ServicesSection";
...
export async function getServerSideProps() {
  const buildersRiskData = await fetchBuildersRiskData();
  return {
    props: buildersRiskData,
  };
}
