...
export default function FaqSection(props) {
  ...
  return (
    <div
      ...
      {...getDataAttrs(props)}
      className={cn(
        "sb-component sb-component-section sb-component-faq-section flex flex-col justify-center",
        colors,
        ...
        <div className={cn("w-full", mapMaxWidthStyles(sectionWidth))}>
          <div className="flex flex-wrap">
            {(props.title || props.subtitle || actions.length > 0) && (
              <div
                className={cn("w-full", {
                  "lg:w-1/3 lg:pr-3": faqItems.length > 0,
                })}
              >
                {props.title && (
                  <h2
